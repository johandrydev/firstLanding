...
const pages = {
    twitter: 'https://twitter.com/johandrydev',
    linkeding: 'https://www.linkedin.com/in/johandry-mora-2477a5175/',
}
 ...
 */
const Footer = () => {
    const redirect = (page) => window.open(page, '_blank');
        ...
        <Section>
            ...
            <div className="footer-content">
                ...
                <div className="div-icons">
                    ...
                    <figure onClick={() => redirect(pages.twitter)} >
                        <img src={twitter} alt="Twitter" width="100%" />
                    </figure>
                    <figure onClick={() => redirect(pages.linkeding)} >
